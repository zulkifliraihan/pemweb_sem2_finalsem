...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Data Perawatan</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
...
<?php
	include './application/views/dashboard/admin/perawatan/modal.php';
	...
	$(document).on('click', '#edit-data', function () {
		...
		$.ajax({
			...
			success: function (response) {
				...
				let perawatan = response.data;

				let formAction = $('#edit-data-form').attr('action');
				formAction = formAction.replace(':did', perawatan.id);
				$('#edit-data-form').attr('action', formAction);

				$('#mobil_id-edit').val(perawatan.mobil_id);
				$('#jenis_perawatan_id-edit').val(perawatan.jenis_perawatan_id);
				$('#tanggal-edit').val(perawatan.tanggal);
				$('#biaya-edit').val(perawatan.biaya);
				$('#km_mobil-edit').val(perawatan.km_mobil);
				$('#deskripsi-edit').val(perawatan.deskripsi);
